...
function get_signature2(ua, user_id) {
    navigator = {
        userAgent: ua
    };
    ...
    !function anonymous() {
        ...
        function c(t, b, k) {
            ...
            for (var h, y, d, g, v = [], x = 0; ;) {
                // console.log("第 " + total_num++ + " 次循环！ v => " + v)
    ...
    return exports.sign(uid)
}

exports.get_signature2 = get_signature2;
