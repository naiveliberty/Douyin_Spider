...
function get_signature(nonce, tac1) {
    var { JSDOM } = jsdom;
    var dom = new JSDOM();
    window = dom.window;
    ...
    window.__M.define("douyin_falcon:node_modules/byted-acrawler/dist/runtime", function(l, e) {
        Function(function(l) {
    ...
    tac = tac1;
    signc = window.__M.require("douyin_falcon:node_modules/byted-acrawler/dist/runtime").sign(nonce);
    return signc
}


exports.get_signature = get_signature;
